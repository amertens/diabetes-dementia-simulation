...
saveRDS(resdf_DetQ_ic, paste0(here::here(),"/sim_res/protective/sim_res_ic.RDS"))
...
saveRDS(resdf_Qint_ic, paste0(here::here(),"/sim_res/protective/sim_res_Qint_ic.RDS"))
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_noDetQ_tmle, paste0(here::here(),"/sim_res/protective/sim_res_noDetQ_tmle_v2.RDS"))
#
#
# int.start.time <- Sys.time()
# resdf_DetQ_ic <- foreach(i = 1:length(d_wide_list), .combine = 'bind_rows', .errorhandling = 'remove') %dopar% {
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_DetQ_ic, paste0(here::here(),"/sim_res/protective/sim_res_DetQ_ic_v2.RDS"))
#
#
#
#
...
# #   return(res)
# # }
# saveRDS(resdf_Qint_noDetQ_lasso_prescreen, paste0(here::here(),"/sim_res/protective/sim_res_Qint_noDetQ_lasso_prescreen.RDS"))
#
#
...
# #   return(res)
# # }
# # saveRDS(resdf_Qint_1se_int, paste0(here::here(),"/sim_res/protective/sim_res_Qint_1se_int.RDS"))
#
#
...
# #   return(res)
# # }
# # saveRDS(resdf_1se_int, paste0(here::here(),"/sim_res/protective/sim_res_1se_int.RDS"))
#
#
#
#
...
#
# gc()
# saveRDS(resdf_glm, paste0(here::here(),"/sim_res/protective/sim_res_glm_ic.RDS"))
#
#
#
#
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_noDetQ_Qint_ic, paste0(here::here(),"/sim_res/protective/sim_res_noDetQ_Qint_ic.RDS"))
#
#
# int.start.time <- Sys.time()
# resdf_noDetQ_Qint_tmle <- foreach(i = 1:length(d_wide_list), .combine = 'bind_rows', .errorhandling = 'remove') %dopar% {
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_noDetQ_Qint_tmle, paste0(here::here(),"/sim_res/protective/sim_res_noDetQ_Qint_tmle.RDS"))
#
#
#
#
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_ic, paste0(here::here(),"/sim_res/protective/sim_res_ic.RDS"))
#
#
# int.start.time <- Sys.time()
# resdf_ic <- foreach(i = 1:length(d_wide_list), .combine = 'bind_rows', .errorhandling = 'remove') %dopar% {
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_ic, paste0(here::here(),"/sim_res/protective/sim_res_Qint_ic.RDS"))
#
#
#
# int.start.time <- Sys.time()
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_EN, paste0(here::here(),"/sim_res/protective/sim_res_EN.RDS"))
#
#
# int.start.time <- Sys.time()
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_Qint_EN, paste0(here::here(),"/sim_res/protective/sim_res_Qint_EN.RDS"))
#
#
# #-
#
...
#   return(res)
# }
# saveRDS(resdf_AUC, paste0(here::here(),"/sim_res/protective/sim_res_AUC.RDS"))
#
#
...
#   return(res)
# }
# saveRDS(resdf_Qint_AUC, paste0(here::here(),"/sim_res/protective/sim_res_Qint_AUC.RDS"))
#
#
#
...
#   return(res)
# }
# saveRDS(resdf_1se, paste0(here::here(),"/sim_res/protective/sim_res_1se.RDS"))
#
...
#   return(res)
# }
# saveRDS(resdf_Qint_1se, paste0(here::here(),"/sim_res/protective/sim_res_Qint_1se.RDS"))
#
...
#   return(res)
# }
# saveRDS(resdf_AUC_1se, paste0(here::here(),"/sim_res/protective/sim_res_AUC_1se.RDS"))
#
# int.start.time <- Sys.time()
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_Qint_AUC_1se, paste0(here::here(),"/sim_res/protective/sim_res_Qint_AUC_1se.RDS"))
#
#
#
#
...
#
# gc()
# saveRDS(resdf_RF, paste0(here::here(),"/sim_res/protective/sim_res_rf.RDS"))
#
#
#
#
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_ridge, paste0(here::here(),"/sim_res/protective/sim_res_ridge.RDS"))
# resdf_ridge
#
#
# int.start.time <- Sys.time()
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_ridge_AUC, paste0(here::here(),"/sim_res/protective/sim_res_ridge_AUC.RDS"))
#
...
#   return(res)
# }
# saveRDS(resdf_Qint_1se_altOrd, paste0(here::here(),"/sim_res/protective/sim_res_Qint_1se_altOrd.RDS"))
#
#
#
# int.start.time <- Sys.time()
...
#
# gc()
# saveRDS(resdf_RF_gcomp, paste0(here::here(),"/sim_res/protective/sim_res_rf_gcomp.RDS"))
#
#
#
# int.start.time <- Sys.time()
...
# difftime(int.end.time, int.start.time, units="mins")
#
# saveRDS(resdf_gcomp, paste0(here::here(),"/sim_res/protective/sim_res_gcomp.RDS"))
